...
function devolverUltimoElemento(array) {
  ...
  // Tu código:
  var primero = array[array.length -1];
  return primero;
}
...
function arrayContiene(array, elemento) {
  ...
  // Tu código:
  respuesta = array.includes(elemento);
  return respuesta;
...
function diaDeLaSemana(numeroDeDia) {
  ...
  var respuesta = "Es fin de semana";
  return respuesta;
} 
  if(numeroDeDia > 1 &&  numeroDeDia < 7){
  ...
  var respuesta = "Entrada no valida";
  return respuesta;
} 
...
function breakStatement(numero) {
  ...
  for(j = 1; j <= 10; j++){
    var suma = suma + 2;
    if(j === suma){
        var suma = "Se interrumpió la ejecucuón";
    return suma;
        }
  }
  lista.push(suma);
