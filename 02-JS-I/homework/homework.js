...
const nuevaString = "hola soy 'humano' ";
...
function esPositivo(numero) {
  ...
  if (numero > 0){
  var texto = "Es positivo";
  return texto;
}
   if (numero === 0){
  return false;
}
  var texto = "Es negativo";
  return texto; 
}
...
function esVocal(letra){
 ...
 // else if(letra.lengt > 1){
  //var texto = "Dato incorrecto";
 // return texto;  
//}
  else var texto = "Dato incorrecto";
  return texto;  
}
